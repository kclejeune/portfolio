<script lang="ts">
  ...
  let colors = {
    ...
    button: {
      active:
        "bg-primary-300 hover:bg-primary-200 dark:bg-primary-800 dark:hover:bg-primary-700 shadow-md",
      inactive:
        "bg-neutral-300 hover:bg-neutral-200 dark:bg-neutral-700 dark:hover:bg-neutral-600 shadow-md",
    },
