...
>
  ...
  <!-- Footer -->
  <AppBar position="bottom" themable={isThemable} hidden={isLandingPage}>
    <div
      class="flex-1 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm {footerTextClass}"
    >
